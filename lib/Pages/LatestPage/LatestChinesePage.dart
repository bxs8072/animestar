...
class LatestChinesePage extends StatefulWidget {
  final MyUser user;
  LatestChinesePage({@required this.user});
  @override
  _LatestChinesePageState createState() => _LatestChinesePageState();
}

class _LatestChinesePageState extends State<LatestChinesePage> {
  LatestAnimeBloc _bloc = LatestAnimeBloc();
  final _controller = ScrollController();
  String _type = "latestchineseanime";
  int _page = 1;
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Latest Chinese Animes Loading...."),
                    ],
                  ),
                );
              }
